!function (e, t) {
    ...
    var t = "SweetAlert2:", f = function (e) {
        ...
        if (t && (t.parentNode.removeChild(t), W([document.documentElement, document.body], [_["no-backdrop"], _["toast-shown"], _["has-column"]])), !j()) {
            ...
            var o, i = k(), r = B(), a = z(r, _.input), s = z(r, _.file), c = r.querySelector(".".concat(_.range, " input")), u = r.querySelector(".".concat(_.range, " output")), l = z(r, _.select), d = r.querySelector(".".concat(_.checkbox, " input")), p = z(r, _.textarea);
        ...
        var r = P(), a = parseInt(null === i.currentProgressStep ? He.getQueueStep() : i.currentProgressStep, 10);
    ...
    var pe = {
        ...
        useRejections: !1,
        expectRejections: !1
    }, fe = ["useRejections", "expectRejections", "extraParams"], me = ["allowOutsideClick", "allowEnterKey", "backdrop", "focusConfirm", "focusCancel", "heightAuto", "keydownListenerCapture"], he = function (e) {
    ...
    }, ve = '"setDefaults" & "resetDefaults" methods are deprecated in favor of "mixin" method and will be removed in the next major release. For new projects, use "mixin". For past projects already using "setDefaults", support will be provided through an additional package.', ye = {};
    var we = [], Ce = function () {
        var e = k();
        e || He(""), e = k();
        var t = Q(), n = E(), o = Z();
        ...
        }(xe("WeakMap"), Object.defineProperty, {}.hasOwnProperty), Be = {
        promise: new Ae,
        innerParams: new Ae,
        domCache: new Ae
    };
    ...
    function Se() {
        var e = Be.innerParams.get(this), t = Be.domCache.get(this);
    ...
    var je, Me = Object.freeze({
        hideLoading: Se, disableLoading: Se, getInput: function (e) {
            var t = Be.innerParams.get(this), n = Be.domCache.get(this);
        ...
        }, showValidationMessage: Pe, resetValidationMessage: Oe, resetValidationError: function () {
            ...
            var t = r({}, Be.innerParams.get(this), {progressSteps: e});
            ...
            return new Promise(function (t, n) {
                var o = function (e) {
                    M.closePopup(T.onClose, T.onAfterClose), T.useRejections ? t(e) : t({value: e})
                }, c = function (e) {
                    M.closePopup(T.onClose, T.onAfterClose), T.useRejections ? n(e) : t({dismiss: e})
                }, u = function (e) {
                ...
                for (var l = function (t) {
                    ...
                    switch (e.type) {
                        case"click":
                            if (i && M.isVisible())if (L.disableButtons(), T.input) {
                                var a = function () {
                                    var e = L.getInput();
                                    if (!e)return null;
                                    switch (T.input) {
                            ...
                            } else l(!0); else r && M.isVisible() && (L.disableButtons(), c(M.DismissReason.cancel))
                    }
                ...
                ce.keydownHandlerAdded && (ce.keydownTarget.removeEventListener("keydown", ce.keydownHandler, {capture: ce.keydownListenerCapture}), ce.keydownHandlerAdded = !1), T.toast || (ce.keydownHandler = function (e) {
                    return function (e, t) {
                        ...
                        } else-1 !== ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"].indexOf(e.key) ? document.activeElement === j.confirmButton && F(j.cancelButton) ? j.cancelButton.focus() : document.activeElement === j.cancelButton && F(j.confirmButton) && j.confirmButton.focus() : "Escape" !== e.key && "Esc" !== e.key || !0 !== H(t.allowEscapeKey) || c(M.DismissReason.esc); else if (e.target && L.getInput() && e.target.outerHTML === L.getInput().outerHTML) {
                ...
                switch (T.input) {
                    ...
                    case"file":
                        ...
                        break;
                    case"range":
                        var w = z(j.content, _.range), C = w.querySelector("input"), k = w.querySelector("output");
                    ...
                    case"radio":
                        ...
                        break;
                    case"checkbox":
                        var S = z(j.content, _.checkbox), P = L.getInput("checkbox");
...
}), "undefined" != typeof window && window.Sweetalert2 && (window.Sweetalert2.version = "7.28.4", window.swal = window.sweetAlert = window.Swal = window.SweetAlert = window.Sweetalert2);
